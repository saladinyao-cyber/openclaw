...
describe("memory_search unavailable payloads", () => {
  ...
  it("classifies persisted index readiness failures separately from provider failures", () => {
    expect(
      buildMemorySearchUnavailableResult("Memory search index identity is mismatched", {
      ...
      action: expect.stringContaining("openclaw memory status --deep"),
    });
  });
